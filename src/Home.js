...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <h1 className="link" style={{...styles.introName, marginLeft:"46%", marginRight:"46%"}}><p className="nav" style={{color:"#ff9450", padding:"1%", margin: 0, marginTop:".75em", display:"inline-block", cursor:"default"}}>Hi,</p></h1>
            <h1 style={{...styles.introName}}> I'm <span className="link" style={{cursor:"default"}}>Ibrahim Mohamed</span>.</h1>
            <h1 style={styles.introLine}>I'm a <p className="nav" style={{color: "#ff9450", display:"inline-block", paddingTop:"1%", paddingBottom:"1%", cursor:"default"}}>Full Stack JavaScript Developer</p> based in <p className="nav" style={{color: "#ff9450", display:"inline-block", paddingBottom:"1%", paddingTop:"1%", cursor:"default"}}>Salt Lake City</p>, Utah.</h1>
